...
public class ContratoAsignadoRequest
{
 ...
 public class ContratoAsignadoRequestValidator : AbstractValidator<ContratoAsignadoRequest>
{
    public ContratoAsignadoRequestValidator()
    {
