...
public class EditarPlanificacionFinancieraRequest
{
...
public class EditarPlanificacionFinancieraRequestValidator : AbstractValidator<EditarPlanificacionFinancieraRequest>
{
    public EditarPlanificacionFinancieraRequestValidator()
    {
